...
const EventDates = () => {
    const dates = [
        {name:"Traditional Wedding", date:"Thursday December 9th, 2025 - Minna, Niger State", details: "Come and be a part of this unique celebration of the marrying of multiple cultures as we celebrate our wedding and acknowledge our heritage and families"},
