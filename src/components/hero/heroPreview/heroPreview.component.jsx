import "../heroPreview/heroPreview.styles.scss";
...
const HeroPreview = () => {
    ...
    return (
        <div id="heroPreviewComponent">
            <img id="heroImage" src={HeroImage} alt="Photo of Eric and Faith" />
            <p className="emblemfont">#ForeverFaithAndEric</p>
            <img id="heroImageMobile" src={HeroImageMobile} alt="Photo of Eric adjusting Faith's hair" />
